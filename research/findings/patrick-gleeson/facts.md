...
> **August 2026 revision — what changed.** The Catherine Hayes vetting plan (`research/analysis/catherine-hayes-vetting-plan-2026-08-18.md`) and its follow-ups produced nine corrections plus the 1879 civil marriage certificate. All are now folded into this file. The headlines:
>
> - **Patrick is named as Catherine's father** on her 1879 civil marriage certificate — the first document to state a parent-child relationship for him directly. See the 29 Nov 1879 civil row.
> - **The 1833 baptism is at EMLY, Co. Tipperary**, not Hospital — and **Ballinvriana is a Tipperary townland**. It sits ~3 km from Hospital village, so calibrate accordingly. ⚠️ **Do not describe this as confirming a "from Tipperary" family tradition** — see the provenance warning in the birth section.
> - **The "third Patrick c. 1837" hypothesis is retired.** The register window was swept and there is no such child.
> - **The sibling set is now nine**, with an ordered residence sequence.
...
- ### ⚠️⚠️ Parents — the [T1] tag below is WRONG. Flagged 2026-08-20.
  **No document anywhere names Patrick's parents.** Not the 1860 marriage (pre-1864 Latin register, records no fathers), not the 1897 death certificate (Irish death certs never name parents), not his children's baptisms (no grandparents), not the Petty Sessions, not the civil birth registrations where he is the informant.
  The four Hospital/Emly baptisms prove that **a couple named James Gleeson and Honora O'Brien existed and had children, including two Patricks.** They do **not** prove our Patrick was one of them. **The only thing linking him to that family is the Irish naming convention** — first son James 1863, second daughter Honora 1866.
  That is the *same soft instrument* now carrying candidate A in the Margaret question, and this family demonstrably breaks the convention at the third daughter (Ellen, not Margaret). **The whole Gleeson line above Patrick rests on one inference.** Re-tag as **[T2]** and treat every ancestor above him as provisional until a document links them.
- **Parents [T1 — see warning above; the tag is retained only to preserve the original text]:** **James Gleeson + Honora O'Brien** of Hospital parish, Co. Limerick (Cashel & Emly diocese). Confirmed by four direct baptism records in the Hospital parish register naming this couple as parents (Patrick 1829, Patrick 1833, Margaret 1842, Catherine 1850). Both names also hit our Irish naming-pattern predictions (father = James per 1st-son rule James 1863; mother = Honora per 2nd-daughter rule Honora 1866). The earlier "Michael Gleeson" Ancestry-tree attribution was wrong, same source-pattern as the disproven sailor/Windmill attributions.
- **Birth [T2]: TWO candidate baptisms in Hospital parish, both to James + Honora O'Brien**, neither independently anchored as ours:
  ...
  - **1833 March 17 — ⚠️ EMLY parish, Co. TIPPERARY, not Hospital** (corrected 2026-08-19/20; `facts.md` previously cited "Hospital parish page 94"). NLI **Emly** register, microfilm 02500/01, **vtls000632708 frame 75**, left page (transcript at `assets/external/misc/patk-honora.md`): *"17 — Patrick of James Gleeson & Honora O'Brien — Sps. Pat^k O'Brien & Ell[en] Walsh — Ballinvriana"*. Sponsors are O'Brien-side maternal kin. **The sponsor reading Pat^k O'Brien is correct as recorded** — it was challenged in error during the 2026-08-18 session and the challenge was withdrawn; see correction #8 of `research/analysis/catherine-hayes-vetting-conclusions-2026-08-18.md` and the transcription rule it produced.
  - ### ⚠️ 2026-08-20 — Ballinvriana is in Co. TIPPERARY, and this documents the family tradition

    **Ballinvriana = Ballinvreena, Co. Tipperary — barony of Clanwilliam, civil parish of EMLY**, ED Rodus, 382 acres; Irish *Baile an Bhrianaigh* (verified against townlands.ie, 2026-08-20). So in March 1833 James Gleeson and Honora O'Brien were **resident in Tipperary**. That is a documented fact and it stands on its own.

    ### ⚠️⚠️ But do NOT present this as confirming a family tradition — the "tradition" is one hedged email

    **Provenance, checked 2026-08-20.** The entire "from Tipperary" lore traces to a single 2025 contact with **Robert Gleeson Sr.** (`research/results/gleeson-initial.md`). The **only verbatim quotation** preserved from him is:

    > *"Dad mentioned relatives from Wisconsin traveling to **Cork** to visit Gleeson relatives there"*

    **Cork — not Tipperary.** "Tipperary" appears nowhere in the quoted words; it survives only in a summarising bullet ("Extended family also lived in Tipperary and Cork") written by whoever took the note. Matt's own recollection of the exchange is that it was a single DM along the lines of *"dad remembers grandpa talking about family going back to Cork to visit, maybe Tipperary"* — i.e. **Tipperary was the hedge, Cork was the claim**, and it is third-hand (Robert's father's memory of his grandfather).

    ⚠️ **The same source produced at least two claims since disproven** — that Patrick was the "sailor at The Windmill, Limerick City" (contamination from an unrelated family, withdrawn), and that James may have married in Ireland (he married in Wisconsin in 1892). It is friendly recollection, not testimony.

    **So the Emly find and the lore must not be used to corroborate each other.** Treating a hedged, partly-discredited, third-hand DM as independent confirmation of a document — or the document as vindication of the DM — manufactures convergence out of one weak source and one unrelated fact. `docs/project_incoming/tree-2026-06-03.md`'s line that *"Robert Gleeson's tri-county lore turned out to be literal geography"* is exactly this error and should not be repeated.

    **Correct statement:** the family was resident in a Tipperary townland in 1833, three kilometres from the Limerick line. Nothing in the record speaks to a family tradition, and **Cork remains entirely unevidenced** — the Cork lead is already correctly parked.

    **But calibrate it — this is a three-kilometre Tipperary.** Ballinvreena lies roughly **3.4 km from Hospital village and 3.2 km from Emly village**, almost exactly on the county line. This is *not* a family that migrated from Tipperary into Limerick. It is a family living **on the boundary** that used whichever chapel was nearer at the time — which is why exactly one baptism out of nine lands in a Tipperary register while the rest are Hospital. (FamilySearch indexes only **four** Gleeson baptisms at Emly across 1820–45, so the family's appearance there is an outlier in that register, not a pattern.) **Do not over-tell the Tipperary story.**

    **Untested hint, recorded because it is cheap:** *Baile an Bhrianaigh* means O'Brien's town; the mother is Honora **O'Brien**; the 1833 sponsors are **Pat O'Brien** and Ellen Walsh; the 1842 sponsor is **Margaret O'Brien**. The couple may have been living on her people's ground before moving to Herbertstown by 1838. The placename is medieval and proves nothing on its own — the **Tithe Applotment book for Ballinvreena (~1826–34)** is the direct test.
...
- **Migration:** Patrick migrated **~25 miles west from Hospital parish to Croom (Scagh townland)** as a young adult, sometime between 1849 (post-Famine emigration era) and 1859 (first Croom Petty Sessions appearance at Scagh). Patrick is a **Limerick–Tipperary borderlands child** (Hospital parish is on the Tipperary border) who moved west to Croom, with cousins later following. ⚠️ *Previously framed as fitting "Robert Gleeson's tri-county lore" — that framing is withdrawn; the lore is one hedged third-hand DM whose only quoted word is **Cork**. See the provenance warning in the birth section. The borderlands description stands on the baptism records alone.*
- **Wife:** Margaret **Moloney** [T1] (Latin *Margaritæ Moloney* in Croom register).
  ...
  - **Margaret's natal family — Tier 1 baptism + Tier 2 identity linkage:**
    ...
    - **Identifying this Margaret as ours — ⚠️ [T2], STRONG BUT CONTESTED (downgraded 2026-08-20).** The baptism proves *a* Margaret to James Molony + Catherine Kenny; identifying her as *our* Margaret rested on four convergent inferences (mother Catherine matched the pre-registered 1st-daughter prediction; Kilfinny parish; father James; 9–10 yr age-shave), strengthened 2026-06-09 by the **18 Nov 1860 marriage recording the bride as "de Kilfenny" (= Croagh parish)**.

      ### ❌ The "unique Margaret" argument is WITHDRAWN — there is a second candidate

      The claim that *"the 31 Dec 1836 Margaret is the **unique** Margaret Molony baptized in Croagh in the window"* **is false**. A second exists:

      > **Margt Moloney, baptised 21 October 1840, Croagh (Kilfinny)** — father **Michl Moloney**, mother **Hanora Moinehan** (= Honora Minihan). Ancestry coll. 61039 record 2561506, microfilm 02420/03; read at detail level 2026-08-20.

      She is a **sister of Jeremiah Molony of Ballymackeamore** (bapt. 28 Oct 1842), of **James** (bapt. 8 Oct 1847 — the 1874 groom) and of **Bridget** (bapt. 27 Aug 1845).

      **The identification may still be right — but it can no longer rest on uniqueness.** What still supports it is genuinely good: the naming convention fits candidate A three-for-three *in order* (1st daughter Catherine → maternal grandmother **Catherine Kenny**; 1st son James → paternal grandfather James Gleeson; 2nd daughter Honora → paternal grandmother Honora O'Brien), and the 1901/1911 censuses shave exactly the documented 9–10 years against an 1836 birth. Under candidate B both grandmothers would be *Honora*, so the **first** daughter should have been Honora — she was not.

      ⚠️ **But candidate B explains four things A leaves unexplained** — the 1881 godparenthood, the 1918 Jeremiah→Margaret mortgage release, Helen Ryan as "Cousin" at Catherine's 1944 deathbed, and the 1860 witness "Michaele Moloney". **Do not resolve this on tidiness.** Full analysis, both cases, and a decisive falsifying test: `research/analysis/margaret-moloney-two-candidates.md`.

      **The test:** find what became of the 1840 Margaret. If she married elsewhere or died, A stands unshaken. Croagh's marriage register survives from 1844, so unlike her parents' generation, her marriage *would* be in it.

      NB: no record will ever directly *name* our Margaret's father — the 1860 register predates the father-naming civil format.
    ...
    - ### ⚠️ 2026-06-09 RECONCILIATION — Kate/Jeremiah are NOT siblings; "niece/first-cousin" RETRACTED
      The 2026-06-08 "Kate = Margaret's sister / Jeremiah = Margaret's brother / Helen = first cousin / T1.5 promotion" claims (preserved struck-through below) are **superseded by direct records found 2026-06-09:**
       - **Jeremiah Molony (the 1918-deed Ballymackeamore man + Kate's father per 1911 census) was baptized 28 Oct 1842, Croagh, to MICHAEL Molony + Honora Minihan** — *not* James Molony + Catherine Kenny (FamilySearch parent-index). So **Jeremiah is NOT Margaret's brother**, and **Kate (his daughter) is NOT Margaret's niece.**
       - **Most likely relationship:** if Michael Molony (Jeremiah's father + Margaret's 1860 marriage witness) and James Molony (Margaret's father) were **brothers**, then Margaret & Jeremiah = first cousins → **Kate = Margaret's first cousin once removed → Helen/Ellen = Catherine's ~2nd cousin once removed** ("cousin" on the 1944 estate still fits, just farther out). **This brother link is UNPROVEN and likely unprovable** (Croagh registers begin 1836; both men b. ~1805–15 → no baptisms survive).
       - **Griffith's correction (~1851):** Ballymackeamore (Kilfinny) occupiers were Noonan, Roche, Harman, Burns, Pigott, Quaide, Houlahan, Keyes, Foley, Dea, Hickey, Hayes — **NO Molony, NO Kelly.** The earlier "Griffith's puts Michael Molony + John Kelly at Ballymackeamore" claim is **WRONG**; both families are post-1851 in-migrants there. James Molony + Michael Molony hold **no land in Kilfinny/Croagh** in Griffith's → James (Margaret's father) likely **died before ~1851** (consistent with the older generation).
       - **James Moloney the 1881 Croom Shopkeeper** (Patrick's 1881 godfather-baptism host) remains a *plausible* brother of Margaret (1st-son naming rule), but is also now only inference — not upgraded.
...
| Baptism | Sibling | Parish | Townland | Sponsors | Evidence |
|---|---|---|---|---|---|
| 20 Mar 1829 | Patrick Gleeson (†? — see birth discussion) | Hospital | — | Stephen Gleeson + Bridget Higgins | image |
| **29 Aug 1830** | **Mary Gleeson** — *NEW* | Hospital | — | — | index |
| 17 Mar 1833 | **Patrick Gleeson** (probably ours) | **Emly, Co. Tipperary** | **Ballinvriana** | Pat^k O'Brien + Ellen Walsh | image |
| **12 Jul 1835** | **Malachy Gleeson** — *NEW* | Hospital | — | — | index |
| **Apr 1838** | **Edmund Gleeson** — *NEW* | Hospital | **Herbertstown** | J[no] Gleeson + Biddy Connelly | **image** |
| **20 Sep 1839** | **Honora Gleeson** — *NEW, probable* | Hospital | **Herbertstown** | Tom Lonergan + Mary [Lacy] | **image** |
| **5 Jun 1842** (⚠ *not* ~3 Nov/Dec) | **Margaret Gleeson** [T1] | Hospital | Herbertstown | Michael Callahan + Margaret O'Brien | **image** |
| **3 Jul 1845** | **James Gleeson** — *NEW* | Hospital | — | — | index |
| 10 Mar 1850 | **Catherine Gleeson** [T1] | Hospital | Hospital town | John Gleeson + Catherine [C___an, working read: Callaghan] | image |

**Notes on the new entries.** *Malachy* is a distinctive name and a good future search handle. *Honora 1839* is flagged **probable** rather than confirmed: the surname (Gleeson), mother (*Norry Brien* — the standard diminutive of Honora) and townland (Herbertstown) are unambiguous, but the father's forename is an abbreviation with a superscript that will not separate *Jas* from *Jos* at the NLI scan's 1500 px ceiling. *Edmund 1838* is confirmed by the Herbertstown townland matching Margaret's.

⚠️ **Margaret's baptism is 5 June 1842**, per the image — not the "~3 Nov/Dec 1842" previously recorded. Sponsors and townland are otherwise exactly as recorded here.
...
### ⚠️ Same-name hazard in this parish

The sweep found **at least four distinct James Gleeson couples in Hospital parish, 1836–44** — James × Honora O'Brien (ours), James × Kitty Green, James × Mary Slattery, and **James × Ellen Moore living at Herbertstown itself** (daughter Norry, 11 Nov 1844). **"James Gleeson of Herbertstown" is therefore not a unique identifier**, and any bare "James Gleeson, farmer" in a later record is weak evidence for our family. Other Gleeson households seen in passing: John Gleeson × Biddy Higgins (Herbertstown), and Gleeson women marrying Dwyer and Power at Herbertstown.

### Residence sequence — now ordered, and it crosses a county line

Hospital town (1829, 1830) → **Ballinvriana / Emly, Co. TIPPERARY (1833)** → Hospital (1835) → **Herbertstown (1838, 1839, 1842)** → Hospital town (1850).

This supersedes the earlier "family rotated through three townlands" note, which had no order and no explanation. See the Tipperary discussion in the birth section above: Ballinvreena sits ~3 km from each of Hospital and Emly villages, on the county boundary, which is why one baptism falls into a Tipperary register.
...
**2026-06-07 update: John 1850 sponsor is almost certainly Patrick's brother, not his uncle.** Griffith's Valuation (~1850) shows both **Patrick Gleeson + John Gleeson at Smallcounty barony, Baggotstown West townland, Knockainy civil parish (= Hospital Catholic parish overlay)** with the **same lessor: Edwd D Freeman Esquire** (Ancestry record ids 1653012 + 1553191). Same townland + same lessor = adjacent plots held by relatives. Chain:

1. John Gleeson sponsor at Catherine 1850 Hospital baptism (this section above)
2. Patrick + John together at Baggotstown West c. 1850 in Griffith's
3. **John Gleeson late of Baggotstown West, Hospital, Co. Limerick, Farmer, died April 1902** (Ireland Will Index 1908, granted to Margaret Gleeson the widow — see `assets/external/familysearch/patrick-gleeson-fulltext-2026-06-07.md` §14)
4. **Margaret Gleeson Widow d. 14 Mar 1910 Baggotstown West, Hospital** (already listed in the disambiguation section below) = John's widow, Patrick's sister-in-law

This adds **John Gleeson c. 1820s–1902** as a documented 4th sibling of our Patrick, and identifies the Margaret Gleeson Baggotstown West Widow 1910 as Patrick's sister-in-law (not a competing candidate for our Margaret Moloney). See [[gleeson_baggotstown_west_brothers]] memory.

Note: the Griffith's Patrick at Baggotstown West is ambiguous as to whether it = our Patrick (pre-Scagh move, before 1859) or a third sibling Patrick; do NOT assume identity without further evidence. Source: `assets/external/ancestry/patrick-gleeson-griffiths-2026-06-07.md`.
...
| **18 Nov 1860** ⭐⭐⭐ | **Patrick × Margaret marriage — FOUND & DOCUMENTED [T1]** (located 2026-06-09, verified against the register image). Croagh/Kilfinny RC marriage register, NLI vtls000634972 **page 14**: *"Novr. 18 — Patritius Gleeson de Croom & **Maria Moloney de Kilfenny** in Matrimonio conjuncti sunt, habita dispensatione tam in Banniis quam in **3tio + 4to gradu Consanguinitatis**. Testes: **Michaele Moloney** & Joanne [Nash?]."* Three load-bearing facts: **(a)** the only Patrick Gleeson marriage in the register across 1856–1862 (full sweep pp.10–15); no Croom duplicate (Croom marriage p.149 read, none) — so this is *the* record. **(b) Consanguinity dispensation, 3rd-and-4th degree** — Patrick and his bride were blood relatives (shared ancestor ~late 1700s); the Gleeson and Moloney lines were already intermarried before this marriage [new constraint — see also Q#5 re Stephen]. **(c)** This 1860 Latin parish register **records no fathers or ages** (civil registration began 1864), so **no surviving marriage or baptism record will ever name Margaret's father** — the natal-family lock must come from the Moloney sibling baptisms + the consanguinity thread. **Maria/Margaret flag:** the bride is written *Maria* here, but **three baptisms (Catherine 1862, James 1863, Honora 1866) + the 1911 census + 1918 deed + 1922 death all read *Margaret***; "Maria" is a lone scribal slip. Witness Michael Moloney + bride "de Kilfenny" corroborate the natal parish + Moloney kin. | NLI Croagh/Kilfinny marriages, vtls000634972 p.14 — https://registers.nli.ie/registers/vtls000634972#page/14/mode/1up (verified 2026-06-09) |
| **31 Jan 1862** ⭐⭐ | **Baptism of daughter Catharina Gleeson at Croom** [T1] — **manuscript image pulled & read 2026-06-09** (Croom CPR vtls000634977 **page 81**, top entry): *"Jan.s 31 — Catharinam filiam Patritii Gleeson & **Marg.m [Margaritam] Moloñy de Scagh** — Suscep.s **Johanne Moloñy & Brig. Gleeson**."* Mother confirmed **Margaret** (not Maria — same page spells "Mariam"/"Maria" with a clearly different hand, disambiguating the marriage's "Maria" as a slip). **"de Scagh"** pins it to our Patrick. Sponsor **John Moloney** = another Moloney tie at the firstborn's baptism. NB: godmother **Bridget Gleeson** is NOT daughter Bridget (b.1881) — Catherine is the firstborn. **⭐ IDENTIFIED 2026-08-18:** she is **Bridget Gleeson of Scagh, daughter of James Gleeson farmer**, who married **Thomas O'Shea** of Croom on **27 August 1864** (Croom civil certificate 1864 entry 23; witnesses William Storan and Ellen Moloney; celebrant John Quinlan P.P.). Godmother-and-bride are the same woman — **probable, bordering on established** — on matching townland (Scagh) and matching associate circle. **⭐⭐ FULLY RESOLVED 2026-08-20 — and she is NOT a relative.** Bridget was **baptised at CROOM on 22 January 1841**, daughter of **James Gleeson and Bridget Storen** — a *second* James Gleeson family, of Croom, entirely distinct from Patrick's father James Gleeson of Hospital who married Honora O'Brien. Her siblings were **Timothy (1831), James (1844), Catherine (1846)**. ⚠️ **This supersedes both earlier readings.** Do not write "sister", and **do not write "kinswoman" either** — she is **not documented as a blood relative at all**. What *is* documented is a close **social** bond: a Gleeson neighbour at Scagh who stood godmother to Patrick's firstborn and whose husband godfathered his next daughter. **This also explains why the Hospital and Emly sweeps came back empty** — she was never in either register. See `research/results/gleeson-timothy-skagh-2026-08-20.md` §8. Earliest direct attestation of Patrick + Margaret as a couple. Catherine = firstborn, predates James (Dec 1863). | NLI Croom CPR vtls000634977 p.81 — https://registers.nli.ie/registers/vtls000634977#page/81/mode/1up (verified 2026-06-09) |
...
| **26 Apr 1869** | Defendant in dog-license sweep at Croom Petty Sessions. Complainant **Constable John Flynn, Croom**. Pleaded Guilty to "Having [dog in] possession without License." Fined 1 penny + costs + order to take out license. Residence on record: **"Scough"** (= Scagh). Justices: Edwd J. Smith + (Defernon?). **Same court session lists "Patt Molony Anded"** — Patrick Moloney of Anhid townland, an established Croom-area Moloney sponsor surname (likely Margaret's relative). Multiple co-defendants from Scagh-cluster townlands: Patrick Dalton (Boherard), Patrick Quard (Ballintaw), Denis Slater (Manister), Thomas McNamara (Toureen), John Kiely (Corrobill), Bridget Maskell (Hullar). **Extends Patrick's documented Scagh residency to 1869** (5 yrs past prior last attestation). | NAI Petty Sessions Order Books, CSPS1/8383; FamilySearch image 150 of 829, IGN 005174405 |
| **24 March 1866** | **Daughter Honora Gleeson — born ~22–24 March 1866 at Skagh, baptized 24 March, civil-registered 25 March** [T1]; Patrick = **Farmer** at Skagh; mother **"Margaret Gleeson nee Moloney"**; baptism sponsors Thomas Shea + **Ellen Moloney** (a Moloney godparent). The dates are internally consistent (birth → same-day baptism → next-day registration). **Superseded misreads (do not resurrect):** "10 March 1866" (Gemini index draft) and "24 Feb 1866" (a 2026-06-09 image-misread of the month — impossible against the 25 March civil registration). | Baptism: NLI Croom CPR vtls000634977 p.93; civil reg: irishgenealogy.ie Croom SRD |
| **15 Dec 1872 → reg. 1 Jan 1873** ⭐ | **Daughter Mary Gleeson born at Skagh**; Patrick = Farmer at Skagh; mother named as **"Margaret Gleeson nee Moloney"** [T1]. Civilly registered 1 Jan 1873. **Extends documented Farmer-at-Skagh residency by 3+ years past the 1869 Petty Sessions attestation, and narrows the Skagh → Main Street Croom move window to 15 Dec 1872 ↔ 3 Nov 1881** (Patrick is Shopkeeper at Croom village by Bridget #8's birth reg). Confirms Mary's baptism 18 Dec 1872 was a standard 3-day Irish-Catholic interval after birth. | irishgenealogy.ie civil birth reg, Croom SRD — https://www.irishgenealogy.ie/view/?record_id=e768beed6b-5939407 (find 2026-06-08) |
| **22 Sep 1879** ⭐ | **Witness ("Coram") at Michael Shanahan + Catherine [Sy—, probably Synan — NOT Lynch] marriage at Croom** ⚠️ *The bride's surname was previously recorded as "Lynch". On the image it begins with a clear **S**. A plausible origin of the error: entry 92 on the 1879 civil-marriage return page is a **Jane Lynch**. The forename Catherine is corroborated by the civil certificate two months later, which names the witness as **Kate Shanahan**.* (NLI vtls000634977 page 161 left column): *"Michaelum Shanahan et Catherinam Lynch. Coram Patritio Gleeson et Catherina Kennedy. Joannes Quinlan cc"*. Direct proof of life and active social standing at Croom. Two months later, Michael + Catharina Shanahan reciprocally witness Patrick's daughter Catherine's marriage to John Hayes (see 29 Nov 1879 row). | NLI Croom CPR marriage register, page 161 (Sep 1879 to Jun 1884); Gemini transcription at `assets/external/catherine-marriage-maybe.md` |
| **29 Nov 1879** ⭐⭐⭐ | **Daughter Catherine Gleeson married John Hayes at Croom** — officiant Rev. John Quinlan CC (the same priest who baptized James, Mary, Margaret etc.). Witnesses Michael + Catharina Shanahan (reciprocal witnesses — Patrick had witnessed Michael's wedding 2 months earlier). Catherine emigrated with John ~1895; she is "Mrs. John Hayes of Staten Island" named in James's 1946 obituary as a surviving sister. **This *anchors* the identification of Catherine Hayes 1944 Staten Island as Patrick + Margaret's daughter, and confirms she was their firstborn (b. before James 1863).** *(Wording softened from "locks" 2026-08-19: the obit lists her as **surviving** fifteen months after she died on 1 Nov 1944 — almost certainly stale family knowledge in Minnesota, but it means the obit's sister-list reports what Minnesota knew, not who was alive.)* **⭐ 2026-08-20 — the identification no longer rests on any of this.** The **civil** certificate for this marriage names Catherine's father outright: see the row below. | NLI Croom CPR marriage register, page 161; entry: *"Die 29th Joannem Hayes et Catherinam Gleeson. Coram Michaele et Catharina Shanahan. Joannes Quinlan cc"* |
| **29 Nov 1879** ⭐⭐⭐ | **CIVIL certificate of the same marriage — Patrick is NAMED as Catherine's father [T1].** Croom SR district, marriage **No. 93**, GRID **2662886**. Column 8 **"Patrick Gleeson"**, column 9 **"Farmer"**; the bride is entered as **"Farmer's daughter"**, residence **Croom**. Groom **John Hayes, Weaver**, father **Peter Hayes, Weaver**, of Croom. Celebrant John Quinlan P.P.; witnesses Michael and Kate Shanahan; registered 1 Dec 1879 by Wallace, Deputy Registrar. **This is the first record in the entire file to state Patrick's relationship to Catherine directly** — the 1862 baptism records her *birth*, the Latin marriage entry names no fathers, and every American source is third-hand. **Caveat: no mother is named**, so the tie to Margaret Moloney remains convergence. ⚠️ **"Full age" is formulaic on this page** (entry 92 says it too) and yields no usable age — Catherine was in fact 17. ⚠️ **Residence "Croom" does NOT establish the Skagh→Main Street move**: this registrar enters district-level place names, and Patrick is still styled *Farmer* here. **Occupation consequence: the Farmer→Shopkeeper pivot narrows from 15 Dec 1872 – 3 Nov 1881 to 29 Nov 1879 – 3 Nov 1881.** | irishgenealogy.ie GRID 2662886, image `marriage_returns/marriages_1879/11085/8056995.pdf` p.147; crop at `assets/external/catherine-hayes-1879-civil-marriage-entry93.png`; analysis at `research/results/gleeson-catherine-1879-civil-marriage.md` |
| **17 Feb 1881** ⭐ | **Sponsor (godfather) at Croom baptism** of *Joannes filius Jacobi Moloney et Honoraea [Quaid]* — co-sponsor *Joanna [?]*. Entry on page 125 of Croom baptism register (vtls000634977). **Civil corroboration:** John Moloney born 8 Feb 1881 at Croom (entry 224, group 02039156, register page 203) — father James Moloney, mother Honoria Moloney formerly Quaid, Shopkeeper at Croom. 9-day birth-to-baptism interval confirms it is the same child. The civil record's "Honoria Quaid" superseded my earlier baptismal misreading of "Honoraea David". **Probable proof-of-life for our Patrick** as godfather at a Moloney Shopkeeper family baptism — the same well-off Croom merchant cluster Margaret's family belongs to. **Awaits Patrick-side corroboration** that the godfather is OUR Patrick, but the surrounding evidence is consistent. | NLI Croom CPR microfilm 02427/07, page 125; civil reg image at `assets/external/civil-births-croom-1879-1886/` (John Moloney 1881 visible on page 203 of `mary_1881.pdf` entry 224) |
| **3 Nov 1881** ⭐⭐ | **Registered the birth of his daughter Bridget Gleeson** at Croom Registrar's Office. Bridget born 11 Oct 1881 at Croom; Patrick signed Form A as informant — *"Patt Gleeson, Father"* — in his own hand (literate). Occupation recorded as **Shopkeeper**, residence **Croom** (not Scagh). **Hard proof of life and direct attestation that Patrick was alive, literate, operating as a Shopkeeper at Croom by 3 Nov 1881.** Tightens death window to **3 Nov 1881 – 31 Mar 1901 (~19 yrs)**. Also documents the **occupation pivot from Farmer (1859/1864/1869) to Shopkeeper** and the **residence move from Scagh townland to Croom village** — both completed during Patrick's lifetime, not after his death as previously inferred. | irishgenealogy.ie civil birth registration; PDF at `assets/external/civil-births-croom-1879-1886/bridget_1881.pdf`; group registration ID 10767889, register page 189, entry 78 |
| **4 Jul 1883** | (TBD — FS-indexed entry; content missing from public view; needs NAI lookup) | FamilySearch (incomplete) |
| **7 Dec 1897** ⭐⭐⭐ | **Patrick's death — CONFIRMED [T1].** Patrick Gleason, Married, age **60**, occupation **Carrier**, died Croom; cause morbus cordis auricular (12 mo, certified). Informant: **"Bridget Gleeson, Daughter, present at death, Croom"**. Registered 13 Dec 1897 by Mich Shanahan, Asst Registrar. **Confirmation chain:** the 1924 marriage record of his daughter Bridget Gleeson to Michael O'Connor (see 4 Mar 1924 row below) names her father as **"Patrick Gleeson, Farmer, Main Street Croom"** — direct daughter-cert attestation to a deceased father at the same address as the 1897 cert and the 1901/1911 widow. **Implications:** (a) Patrick's death window collapses to 7 Dec 1897 (was 1881–1918); (b) ~~age 60 → b. ~1837 — tilts the 1829/1833 baptism question toward a third c. 1837 candidate (Hospital register 1833–1842 gap is now a top-priority search target)~~ **← RETIRED 2026-08-20. The Hospital register was swept at 2× magnification for January 1836 – December 1844 and contains no third Patrick to this couple — only Edmund (April 1838) and Honora (20 Sep 1839), both Herbertstown, plus Margaret (5 Jun 1842). A 4-year shave (if 1833) or 8-year (if 1829) on a death certificate reported by a daughter is unremarkable in a family where Margaret and Catherine each shave 9–11 years. The stated age 60 is ordinary noise, not evidence for an undiscovered child. The question is back to a clean 1829 vs 1833.** Only Emly 1836 – early 1838 remains unswept, and the family was at Herbertstown by April 1838, so that gap is narrow. See `research/results/gleeson-bridget-baptism-search.md`; (c) occupation trajectory across his life: **Farmer** (1859/1864/1869 court records), **Shopkeeper** (1881 birth reg of Bridget #8), **Carrier** (1897 death cert), with daughter recalling him as Farmer 27 yrs later in 1924 — the multi-occupation pattern is real, not inconsistent. See [[gleeson_patrick_1897_death_candidate]] memory. | irishgenealogy.ie group reg ID 4224783; PDF at `assets/external/familysearch/patrick-gleason-death-cert-1897.pdf` |
| **31 Mar 1901** | 1901 Census of Ireland: **Margaret Gleeson, age 55, Widow, Head of Family** at **House 36, Main Street, Croom, Co. Limerick**. Occupation **Shop Keeper**, R.C., reads + writes, born Co. Limerick. **Patrick is dead by this census date.** Household includes daughters Mary (24, Dress Maker, Single) and Bridget (18, House Keeper, Single) + boarder John Fitzgerald (36, Miller). Mary and Bridget here are likely **undocumented younger daughters** (b. ~1877 and ~1883 — younger than our documented Mary 1872 and Bridget 1868). **A separate Mary Gleeson age 27 appears at the Croom Union Workhouse (Skagh townland) as "Matron of Workhouse," likely our documented Mary 1872** working away from home. | NAI 1901 Census, household ref 1488852 (Main Street) + 1488747 (Workhouse, Skagh); PDFs saved in `assets/external/census/` |
| **2 Apr 1911** | 1911 Census of Ireland: same household composition at **House 32, Main Street, Croom**. **Margaret Gleeson, age 66, Widow, Head**, Shop Keeper. **Signed Form A herself** ("Margaret Gleeson" in her own hand), confirming she was literate and competent in 1911 at age 66. Daughters: Mary (28, Dressmaker, Single) and Bridget (25, Dressmaker, Single). Boarder: James Vaughan (40, Carpenter, Single). Enumerator: John Bourke. **Columns 10–12 (years married / children born / children still living) NOT filled in** — enumerator missed the widow case. Margaret stated her birthplace as Co. Limerick and spoke English (not Irish). | NAI 1911 Census, household ref 617554; PDFs saved in `assets/external/census/` |
...
| **4 Mar 1924** ⭐⭐⭐ | **Daughter Bridget Gleeson married Michael O'Connor at Church of Mary, Croom.** Priest: Timothy Curtins PP, Croom. Witnesses: Michael T Bregg + Mary Foley. Bride: Full Spinster, residence **Main Street Croom**, father **"Patrick Gleeson, Farmer"** (i.e., the dead father — Patrick d. 1897). Groom: Full Bachelor, residence Rathdrum, father Michael J O'Connor (Accountant). **This is the marriage that lets us identify the "Mrs. Bridget O'Connor (Croom)" of James's 1946 obit.** Also retrospectively confirms the 1897 Patrick Gleason death cert as our Patrick (same Bridget-daughter, same Main Street Croom address). See [[gleeson_bridget_oconnor_1924_marriage]] memory. **Open:** which of our two documented Bridgets this is — Bridget #3 (b. 1868, would be ~56 at marriage) or Bridget #8 (b. 1881, would be ~43); the Main Street co-residence pattern through 1901/1911 strongly favors Bridget #8, in which case Bridget #3's fate becomes unknown again. | irishgenealogy.ie Civil Marriage group reg ID 1224468, image 5312233.pdf; transcription at `assets/external/familysearch/research-session-2-2026-06-07.md` |
...
5. **Jeremiah Molony of Ballymacamore is Margaret-Moloney kin** — but **NOT her brother** (corrected 2026-06-09: Jeremiah was baptized 28 Oct 1842 Croagh to *Michael* Molony + Honora Minihan, not Margaret's parents James + Catherine Kenny). The mortgage-release is still a family transaction, but between **probable cousins** (likely 1st cousins if James ↔ Michael were brothers — unproven). **Ballymackeamore is in Kilfinny parish** = Margaret's confirmed natal parish (Croagh/Kilfinny).
...
- **Children** — 9 documented (1 Croom marriage record 1879 + 7 Croom baptisms 1863–1878 + 1 civil birth registration 1881):

| # | Name | Birth / Baptism | Notes |
|---|------|---------|-------|
| 0 ⭐ | **Catherine Gleeson** (firstborn — predates James) | **Baptized 31 January 1862 at Croom** [T1] — **image verified 2026-06-09** (NLI Croom CPR vtls000634977 **page 81**, top entry): *"Catharinam filiam Patritii Gleeson & Margaritam Moloñy de Scagh; Susceptores Johanne Moloñy & Brigida Gleeson."* Birth likely late January 1862 (0–3 day Irish Catholic interval). Triangulates: 17 at 1879 marriage, 22 months older than James (Dec 1863), headstone "1865" off by 3 yrs (engraver approximation), Ancestry tree "1876" off by 14 yrs (wrong). | **Married John Hayes at Croom 29 Nov 1879** (NLI vtls000634977 p.161; officiant Rev. John Quinlan, witnesses Michael + Catharina Shanahan — reciprocal witnesses to Patrick Gleeson's earlier 22 Sept 1879 witness role at Michael Shanahan's wedding). Emigrated to NY with John post-1879 (1898 arrival per US census — unresolved anomaly suggests possibly 1879–1898 in Croom before emigration). Died **1 Nov 1944, 64 Edison St Staten Island**, widowed (John d. 1929). Buried at St Mary's Cemetery Grasmere, Reid Ave Section, in shared Ryan family plot. = "Mrs. John Hayes of Staten Island" in James's 1946 obit. **Cousin executor Helen J. Ryan = Ellen Kelly** (a maternal-side Moloney cousin; **~2nd cousin once removed**, not first cousin — corrected 2026-06-09, see Wife/natal reconciliation) — see [[gleeson_helen_ryan_ellen_kelly_identified]]. |
| 1 | **James (Jacobus) Gleeson** | b. ~23 Dec 1863 (baptism date), Croom | Our direct ancestor. Mother reads **Margarita** (p.87, img-verified 2026-06-09) — one of the three baptisms (with Catherine 1862 + Honora 1866) that make the Maria/Margaret resolution airtight. Sponsors: **William Storan + Margaret Kiely** (resolved 2026-06-01 — the "St" ligature was read as M, H, or Sh by earlier passes; Storan is a Croom-distinctive surname, see disambiguation note below). Officiant: Rev. John (Joannes) Quinlan, C.C. (the consistent Croom curate from at least 1863–1875). Emigrated ~1883 |
| 2 | Honora ("Nora") Gleeson | **Born ~22–24 March 1866 at Skagh; baptized 24 March; civil-reg 25 March** (Croom p.93: *"Honoria filia Patritii Gleeson et Margarita Molony; Spons. Thoma Shea et Ellena Moloney"*). Father = **Farmer** at Skagh, mother Margaret. Superseded misreads: "10 Mar" (Gemini draft) and "24 Feb" (image month-misread). | Fate unknown |
| 3 | Bridget (Brigida) Gleeson | bap. 21–24 Feb 1868 | **Fate uncertain — 2026-06-07 update.** Previously the leading candidate for "Mrs. Bridget O'Connor" of the 1946 obit, but the 4 Mar 1924 Croom marriage of Bridget Gleeson × Michael O'Connor (see life events row) appears to be **Bridget #8** based on Main Street co-residence + 1901/1911 census continuity. If so, Bridget #3 is fate-unknown — possibly died as a child/young adult, or emigrated. See [[gleeson_bridget_oconnor_1924_marriage]] for the reconciliation puzzle. |
| 4 | Ellen / Helena (Ellena) Gleeson | bap. **9 Jul 1869**, Croom, Limerick (date per manuscript re-reading "Die 9no"; earlier "15 Jul" came from index FHL Film 101194 and is superseded). Father Patricii Gleeson, mother Margaritae Moloney. Sponsors **Jeremias O'Leary + Brigida Shanahan**. Officiant **Rev. Joannes Quinlan**. Civil birth reg. 1869, GRO Vol. 15 p. 219 (FHL Film 101046) | Name varies (Ellen / Helena / Ellena) |
| 5 | Mary Gleeson | bap. **18 Dec 1872** (date corrected from earlier index "15 Dec" via manuscript re-read 2026-05-31) — sponsors John + Ellen O'Shaughnessy; officiant Rev. John Quinlan, C.C. | → "Miss Mary Gleeson, Croom" per obit (Workhouse Matron at Skagh, age 27 in 1901 Census) |
| 6 | Margaret (Margarita) Gleeson | bap. 29 Sep 1875 — sponsors William Blake + Ellen Condon; officiant Rev. John Quinlan, C.C. | Fate unknown |
| 7 | Jane / Janet Gleeson | bap. 25–28 Sep 1878 — sponsors Michael Moloney + Maria Quaid; officiant Rev. John Quinlan | Fate unknown |
| 8 | **Bridget Gleeson** ⭐ (the second Bridget) | **born 11 Oct 1881 at Croom; civilly registered 3 Nov 1881** (group reg ID 10767889; Croom SR district, register page 189, entry 78). Father Patrick Gleeson **Shopkeeper**, mother Margaret Gleeson formerly Moloney. Informant: Patrick himself ("Patt Gleeson, Father", own signature). NLI Croom baptism register ends Jun 1881 so no parish baptism record on the swept microfilm. | **2026-06-07: now identified as "Mrs. Bridget O'Connor" of James's 1946 obit.** Stayed at Main Street Croom with widow Margaret through 1901 (age 18, House Keeper) and 1911 (age 25, Dressmaker — both age-shaved). Married Michael O'Connor 4 Mar 1924 at Croom (age ~43, recorded as "Full Spinster"); see 4 Mar 1924 life-events row. **This supersedes the earlier "Nora Gleason d. 1939 Staten Island" hypothesis** — Nora is now locked as Catherine's biological sister (b. ~1875–76; see [[gleeson_nora_1876_1939_sister]] memory), not Bridget #8. The 1881 birth-year match to the Find A Grave Nora was coincidence. |

**Withdrawn 2026-06-01:** A previously-listed 8th child "Ella Isabel Gleason" (the 1874 Eau Claire bride) has been removed. The 1874 marriage record names that bride's father as **C. R. Gleason** (not Patrick), making her a different Gleason family entirely. See "False leads" section below.
...
- **Not either of two Limerick Margaret Gleesons in the 1919 calendar:**
  ...
  - Margaret Gleeson of **Baggotstown West, Hospital** — Widow, died 14 Mar 1910 (grant delayed to 15 Nov 1919); executor Mary Gleeson (Spinster). **2026-06-07: now identified as John Gleeson 1902's widow (Patrick's sister-in-law)** via [[gleeson_baggotstown_west_brothers]].
- **Margaret Moloney of Ballinscola / Shanaclogh — eliminated as a primary kin-link candidate.** This Margaret (d. 9 Aug 1906 Croom Workhouse, age 66, Farmer's Widow, group reg ID 4858114) had previously been treated as a hypothesized relative of our Margaret Moloney (Patrick's wife). Death cert image (`assets/external/familysearch/margaret-moloney-1906-death-cert-2026-06-07.md`) reveals: (a) cause of death was **self-inflicted throat wound 24 Jul 1906 → shock and exhaustion → died 9 Aug 1906**; (b) death registered via **coroner's inquest** (P. J. Cleary, Coroner for Co. Limerick) — **no family informant on cert**; (c) the "Ellen Moloney Spinster" we'd been tracing appears only on the **probate grant**, not on the death cert — Ellen's relationship to the deceased is undocumented and not necessarily kin; (d) place name discrepancy: will calendar says "Ballinscola Herbertstown", cert reads "Shanaclogh". Without a documented kin tie, this Margaret should not be re-chased as a Patrick-side relative. Three other Margaret Moloneys appear in the Croom SRD 1900–1910 death index (1901 age 75, 1905 age 90, 1906 age 66) — none fit our Margaret Moloney (Patrick's wife was alive 1918 per the Registry of Deeds release). Our Margaret's death remains unfound, likely post-1918 and possibly in a different SRD.
...
1. **Croom Catholic marriage register, 29 Nov 1879 (NLI vtls000634977 p.161):** *"Joannem Hayes et Catherinam Gleeson. Coram Michaele et Catharina Shanahan. Joannes Quinlan cc"* — Catherine Gleeson married John Hayes at Croom, officiant the same Rev. John Quinlan CC who baptized James, Mary, Margaret, and our other documented children. **John Hayes belonged to an active Croom Hayes network** — a different *Johannem Hayes married Mariam O'Brien* at Croom 3 Feb 1875 (page-before transcript), and Edmund, Thomas, Ellen, Brigida, Daniel Hayes all appear as Croom witnesses across the 1870s. Our John was a local Croom-area man, not a stranger marrying in from outside.
2. **Patrick Gleeson as reciprocal witness 22 Sept 1879** at Michael Shanahan + Catherine [**Sy—, probably Synan; NOT Lynch**]'s wedding (same page, two months earlier) — Michael & his new wife Catharina Shanahan then witnessed Catherine + John Hayes's wedding. **Downgraded 2026-08-18: the kin-friend witness pattern is *strong contextual evidence*, not conclusive.** The Croom marriage register sweep found **no competing Patrick Gleeson anywhere between Oct 1864 and Jun 1884**, which is the good outcome — but the 1879 entry itself gives no residence, occupation or relationship, so it corroborates rather than proves. The argument is nonetheless better supported than "conclusive" implied, because the **Gleeson–Shanahan tie runs back a decade**: *Anna Gleeson* witnessed the marriage of *Jacobus Shanahan* on **19 June 1869**, and *Patrick Shanahan* witnessed the marriage of *Margaret Gleeson* on **4 August 1869**. Read the 1879 exchange as the late instance of a standing relationship, not a self-standing coincidence. See `research/results/gleeson-croom-marriage-sweep-1864-1884.md`. **(Superseded as the load-bearing argument entirely on 2026-08-20 — the 1879 civil certificate names Patrick as Catherine's father outright.)**
3. **NY 1944 death record** names Patrick Gleason + Margaret Gleason as parents (US-anglicized spelling); informant + executor **cousin Helen J. Ryan (1905–1989)**. **2026-06-08 identification:** Helen J. Ryan was born **Ellen Kelly** on 3 March 1905 at Ballymackeamore Adare to John Kelly + Kate Moloney; she later married Thomas Ryan. **Kate Moloney is strongly inferred to be Margaret Moloney's sister** (Ballymackeamore townland matches the 1918 Jeremiah Molony brother-of-Margaret deed). Therefore Helen + Catherine were **maternal first cousins** — see [[gleeson_helen_ryan_ellen_kelly_identified]] memory. By 1930 + 1940 US censuses, widowed Catherine lived with Thomas + Helen Ryan + their growing family on Staten Island — close-kin care of an aging widowed cousin. Catherine + John Hayes had **NO surviving children** (confirmed across 1900, 1910, 1920, 1930, 1940 US census records).
4. **St Mary's Cemetery Grasmere headstone** (Reid Ave Section): "John HAYES 1862–1929 / Catherine HAYES 1865–1944" in shared Ryan family plot. Headstone birth year "1865" is most plausibly off by 3–8 years — she had to be at least ~17 at the 1879 marriage. Real birth year likely **~1857–1862**.

**Catherine is therefore the FIRSTBORN child of Patrick + Margaret**, predating James (Dec 1863). Added to children table above as #0.

**Implications + retired hypotheses (2026-06-03):**

- The earlier "tentative #9 Catherine c. 1865–1876" framing is **superseded** by the firstborn identification — Catherine wasn't born in the post-Jane 1878 gap; she was the *oldest child*. This explains why the all-Ireland Catherine Gleeson 1873–1880 civil-birth search returned nothing matching: she'd been born pre-1864 civil registration. Her baptism would be on Croom register pages 49–86 (covering ~1853–1863) — partially swept previously for the withdrawn "Ella firstborn" hypothesis, but may need a fresh pass focused specifically on the Catherine name + Patrick Gleeson father.
- The **1894 Teutonic single Catherine Gleeson age 20 → Philadelphia is NOT our Catherine** — she'd been Mrs. Hayes since 1879. That Nenagh-cluster arrival was coincidental name overlap.
- The **1912 Cameronia John Hayes + Agnes is a different John Hayes family** — our John didn't have a first wife Agnes; he was Catherine's only husband. Confirms Interpretation B from earlier analysis.
- The **1915 Rensselaer/Troy Catherine Hayes + John Hayes marriage is NOT ours** — Catherine was already married since 1879.
- Catherine + John Hayes emigrated together post-1879. The Croom baptism register sweep already done (1879–1881) shows no Hayes children for them in Ireland, so they likely emigrated quickly or were childless throughout.

**Strong working hypothesis still standing — Nora Gleason 1881–1939** buried in the same Ryan/Hayes plot is **Bridget Gleeson #2** (b. 11 Oct 1881 Croom) who emigrated to join sister Catherine in NY, going by "Nora" in US life. Awaits 1900–1940 Hayes household census check.

See `research/results/gleeson-catherine-hayes-search.md` for the full identification chain; transcript of the 29 Nov 1879 entry at `assets/external/catherine-marriage-maybe.md`.

### Ella Isabel Gleason "Mrs. John Hayes" hypothesis — historic withdrawal note

An earlier hypothesis (pre-2026-06-01) identified Mrs. John Hayes as "Ella Isabel Gleason" of an 1874 Eau Claire WI marriage record — withdrawn after the marriage record's bride's father was confirmed as C. R. Gleason (not Patrick). That Eau Claire 1874 family is documented in the False Leads section below; not our family. The Catherine identification (above) is the canonical resolution.

### False leads (withdrawn identifications)

These records were previously documented as belonging to our family but have since been rejected:

| Lead | Why withdrawn | Date |
|---|---|---|
| **Ella Isabel Gleason + John Nelson Hayes, 24 Dec 1874, Eau Claire WI** | 1874 marriage record names bride's father as C. R. Gleason, not Patrick. Groom John Nelson Hayes was born Venice, Cayuga Co., NY (son of Henry + Elmira Hayes), and appears to have later partnered with Antoinette "Nettie" Ring (children Ada 1881, Maud 1882, Hugh 1889 in Dunn County WI). Coincidental name match only. Wisconsin Marriage Records Box 674142, Vol. 1, p. 0229. | 2026-06-01 |
...
3. **Patrick + Margaret's marriage record** — ✅ **FOUND & RESOLVED 2026-06-09** (see 18 Nov 1860 row in life-events table). Croagh/Kilfinny register, vtls000634972 p.14. **Key correction to the prior assumption:** the 1860 Latin register does **NOT** name fathers or ages (civil registration didn't begin until 1864), so this record does *not* directly lock Margaret's natal family as hoped. What it gave instead: the **consanguinity dispensation** (3rd-and-4th degree Gleeson–Moloney blood relation) and witness **Michael Moloney**. No Croom duplicate exists (Croom p.149 checked). Natal-family lock now hinges on Moloney sibling baptisms + the consanguinity thread (see Q#1a / Wife section).
...
6. **Margaret Moloney's death** — ✅ **FOUND & LOCKED 2026-06-09** (verified against the register image). **Margaret Gleeson died 18 May 1922 at Croom**, Widow, age **74** (understated — she married 1860, so b.~1836 not ~1848; same ~10-yr age-shaving as her censuses), occupation House Keeper, cause **"fractured femur, shock, certified"**. Informant **"B. Gleeson, Daughter, present at death, Croom"** = daughter **Bridget** (#8, the same caretaker who informed Patrick's 1897 death + married M. O'Connor 1924). Registered 15 July 1922 by **Michl Shanahan, Asst Registrar** (same registrar as Patrick's 1897 death — 25 yrs apart). irishgenealogy.ie `cide-3320749`, entry No. 293. **Distinct from** the rejected Casey/Kilmorna stone (Margaret *Moloney*, 21 May 1922, Kerry, age 84). *Followup ref: hip-fracture mortality in the elderly — https://pmc.ncbi.nlm.nih.gov/articles/PMC3048257/* | Image: https://www.irishgenealogy.ie/files/civil/deaths_returns/deaths_1922/05066/4388518.pdf
...
## BLOCKED follow-ups & remaining mysteries (as of 2026-06-09)

These are the live threads, with what's blocking each:

1. **Margaret's natal family — ✅ LOCKED 2026-06-09** (was the top mystery). Margaret = daughter of **James Molony + Catherine Kenny**, per her **own** 31 Dec 1836 Croagh baptism (FamilySearch parent-index confirms the `croagh-1836.md` transcript; identity = our Margaret is strong via the 1860 marriage's "de Kilfenny" + baptism uniqueness). **Correction:** Jeremiah Molony (whose parentage we'd hoped would lock the family) turned out to be **Michael Molony + Honora Minihan's** son — NOT a sibling — so Kate is **not** Margaret's niece (see Wife/natal reconciliation above). **Remaining (likely unprovable):** whether James ↔ Michael Molony were brothers — would fix Kate as Margaret's 1C1R; Griffith's couldn't test it (neither held Kilfinny/Croagh land in 1851) and pre-1836 baptisms don't survive.
2. **Honora's birth date — ✅ SETTLED (was never actually open):** born ~22–24 March 1866, baptized 24 March, civil-reg 25 March (all consistent). The 2026-06-09 "24 Feb baptism / conflict" was an image month-misread; disregard.
3. ~~**Second 1946 obituary paper**~~ ✅ **DONE 2026-08-20 — and there were THREE printings, not two.** *St. Cloud Times* 28 Jan p.5; *Leader-Telegram* (Eau Claire) **30 Jan p.2**; *Leader-Telegram* **2 Feb p.9**. ⭐ The 2 Feb printing states **"born Dec. 21, 1864 at Croom, County Limerick, Ireland"** — the county in full, and a birth **day and month matching the Croom baptism register exactly**. Full transcriptions and an error table: `research/results/james-gleeson-obituaries-1946-all-printings.md`
4. **Cork relatives lead — PARKED** (anchored plan handed off; do not activate until Margaret's natal family is locked and a pre-1820 Gleeson/O'Brien ancestor is named).
5. ~~**The unidentified 1862 godmother "Bridget Gleeson"**~~ — ✅ **FULLY RESOLVED 2026-08-20.** **Baptised Croom, 22 January 1841, daughter of James Gleeson and Bridget Storen** — a second, unrelated James Gleeson family of Croom. She married Thomas O'Shea 27 Aug 1864. **She is not a documented relative of Patrick's**; the connection is neighbourhood and friendship, not blood. The Hospital/Emly image sweeps came back negative because **she was never in those registers**. Nothing further to search.
6. **⭐ Consanguinity — PROMOTED to an active search target 2026-08-20.** Full analysis: `research/analysis/gleeson-moloney-consanguinity-1860.md`. The previous wording here ("the shared **Gleeson–Moloney** ancestor (~**late 1700s**) is a check to apply once both trees are built, **not yet a search target**") was **wrong on all three counts**:
   - **The surname is not established.** Patrick had eight great-grandparents and Margaret sixteen great-great-grandparents; the common couple could sit on any of those lines. It could be O'Brien–Kenny, or two surnames we have never seen. Gleeson–Moloney is a *leading hypothesis*, held loosely, on the strength of this generation's visible association — which is evidence about 1860, not 1730.
   - **The date is a generation too late.** In the canon computation 3rd degree = second cousins (shared great-grandparent) and 4th = third cousins (shared great-great-grandparent), so a mixed 3rd-and-4th makes Patrick and Margaret **second cousins once removed**. Counting generations at 25–35 years puts the common ancestral couple at **c. 1710–1750**, centring 1725–1745 — before any surviving register in either parish.
   - **It is the single most powerful constraint in the file**, because it binds *both* pedigrees at once: build either line back far enough and it must produce the other. Nothing else here does that, and the Gleeson side badly needs it given the four-plus James Gleeson couples in Hospital parish.

   **⭐ And it may explain the migration.** Patrick moved ~25 miles west from Hospital to Croom, then married a Croagh/Kilfinny woman he was *already related to*. That requires a **pre-existing kin corridor** between the two districts running back to the mid-1700s — so he probably moved **toward known kin** rather than into a void. **Stephen Gleeson** did the same thing (Hospital → Croom/Boherygeela) and *also* married with a dispensation (Mary Twomey, Croom, March 1862, 3rd degree). Two men, same family, same move, both marrying consanguineously within eighteen months. **Cheap falsifiable test: Griffith's Valuation (~1851) for Gleesons in Croom/Croagh/Kilfinny, and for Molony/Kenny in Hospital/Emly.** Griffith's for Co. Limerick falls after Patrick left Hospital and before he surfaces at Scagh in 1859 — exactly the right moment.
...
- **Croom baptisms — current state of search:** Baptism register vtls000634977 swept pages 87–125 (Nov 1863 – Jun 1881), covering all 7 documented baptisms + the post-Jane gap. **No additional Gleeson/Moloney baptism found between Sep 1878 (Jane) and the register's close in Jun 1881.** Page 125 is the last baptism page on this microfilm. New Gleeson sponsors surfaced in the 1879–1881 sweep: William, Mary, Honora — see `assets/external/nli-croom/122_baptism.md`–`125_baptism.md`.
- **Croom baptisms pre-1863** — for possible older siblings of James (if any)
- ✅ **Civil birth registrations 1879–1886 (Croom SRD)** — searched 2026-06-03 via irishgenealogy.ie (`research/results/gleeson-civil-births-croom-1879-1886.md`). 15 Gleeson births returned in Croom SRD; only **one matched our family: Bridget Gleeson born 11 Oct 1881** (Patrick + Margaret Moloney; see Documented life events). The other 14 sort into three other Croom-area Gleeson clusters: (a) **James Gleeson + Margaret Hickey of Fedamore** (Michael 1880, Mary 1881, Margaret 1885 — Labourer → Land Steward over the window); (b) **Stephen Gleeson + Mary Toomey of Boherygeela** (Anne 1879, Patrick 1884 — Farmer; this is our hypothesized Stephen-Gleeson cousin branch); (c) plus several Croom-area Gleesons we haven't yet pulled detail on. The Mary at Main Street in 1901 Census (age 24) is therefore most plausibly our documented **Mary 1872 with a 4-yr age understatement**, not a separate younger daughter. **No Mary Gleeson child of Patrick + Margaret Moloney was civilly registered in Croom SRD 1879–1886.** Lower-priority extension: 1886–1895 civil births if a true late-born daughter is still suspected.
...
- **Bridget Gleeson + Thomas O'Shea married Croom 27 Aug 1864** ⚠️⚠️ **NOT Patrick's sister, and NOT a documented relative at all** (resolved 2026-08-20 — supersedes both the original "highly likely Patrick's sister" and the interim "kinswoman of unestablished degree"). She was **baptised Croom 22 Jan 1841 to James Gleeson and Bridget Storen**, a separate Croom Gleeson family; her brother Timothy married Ellen Storin — their mother's kin — in 1867, which is also why **William Storan** witnesses here. See the 31 Jan 1862 row and `research/results/gleeson-timothy-skagh-2026-08-20.md` §8. ⚠️ Consequently the inference chain built on her below — *"Patrick's sister marries, Margaret's sister stands as witness"* — **loses its first half** and should not be used to support Ellena Moloney as Margaret's sister. Marriage entry, **corrected against the image**: *"**Thomam O'Shea** et Brigidam Gleeson. Coram **Gulielmo Storan** et Ellena Moloney. Joannes Quinlan C.C."* — the groom is **O'Shea** (not "Shea") and the male witness is **Storan** (not "Strau" as here, nor "Stran" as in `assets/external/nli-croom/153.md`). The IrishGenealogy index date of **24 Aug 1864 is an index error**; the certificate says **27 Aug**. (transcript at `assets/external/catherine-marriage-maybe-page-before-6.md`). The female witness **Ellena Moloney** is the same Ellena Moloney who appears multiple times in our family's network — strong candidate for Margaret's sister (witness-pattern: Patrick's sister marries, Margaret's sister stands as witness). They later baptized daughter Catharina 4 Jan 1873 (sponsors William Breen + Alicia Moloney) and daughter Maria 8 Jan 1865 with **Margarita Gleeson as godmother** (= our Margaret Moloney using married name) — page 89 of the Croom register.
- **"Jacobo Gleeson" as sponsor at 6 Sep 1864 Croom wedding** of Gulielmus Riordan + Maria Hanly — *"Jacobo Gleeson et Catherina Bardan Sponsoribus. Joannes Quinlan C.C."* (transcript at `assets/external/catherine-marriage-maybe-page-before-6.md`). **Updated 2026-06-03:** With Patrick's father James Gleeson now locked at Hospital parish (~25 mi east of Croom, b. likely 1790s), this 1864 Croom sponsor "Jacobo Gleeson" is **most plausibly Patrick's older brother** also named James (a younger James Gleeson active in Croom in his 30s-40s) rather than Patrick's father (who would be ~57-67 by 1864 and based at Hospital). Could also be a cousin via the Stephen Gleeson Boherygeela branch. Worth searching Hospital parish 1820s for an earlier James Gleeson son of Patrick's parents (Patrick's older brother).
- **Margaret Gleeson m. Patrick O'Dea 4 Aug 1869 Croom** — *"Patricium O'Dea et Margaritam Gleeson. Testibus Patricio Shanahan et Honoria Egan"* (transcript at `assets/external/catherine-marriage-maybe-page-before-3.md`). Different from our Margaret Moloney (already married to Patrick since ~1855–57). **Candidate for Patrick's sister.**
- **Anna Gleeson m. Michael Carroll 22 Oct 1869 Croom** — *"Michaelem Carroll et Annam Gleeson. Coram Martino Carroll et Margarita Slattery"* (transcript at `catherine-marriage-maybe-page-before-3.md`). Same Anna Gleeson appears as witness 19 Jun 1869. **Candidate for Patrick's sister.**
- **Thomas Gleeson as witness 14 Nov 1868 Croom** — *"Joannem Caulfield et Aleciam OFarrell. Coram Thoma Gleeson et Catherina Spraght"* (transcript at `catherine-marriage-maybe-page-before-4.md`). **Candidate for Patrick's brother.**
...
#### Stephen + Mary Twomey's documented children (2026-06-08)

| Birth | Child | Source | Status |
|---|---|---|---|
| 1864 | **Mary** | Croom SRD civil birth reg | Not in 1901/1911 households — died young or married/emigrated pre-1901 |
| **1866** | **Honora** | Croom SRD civil birth reg, mother "Mary Gleeson (Twoomy)", Boherygeela | Possible match for "Hanoria 32" in 1901 household with 3-yr age-shave; OR died young (replacement-child for 1869 Hanoria) |
| ~1867 | Stephen Jr | 1901/1911 census household | Still in household 1911 |
| ~1869 | Hanoria | 1901 census household | Could be same person as Honora 1866 or replacement |
| ~1871 | Kate/Katie | 1901/1911 census | Still in household 1911 |
| ~1873 | Jeremiah | 1901/1911 census | Head of household by 1911 |
| ~1875 | Timothy | 1901/1911 census | "Tina" in 1911 export (probable transcription error) |
| 1879 | Anne | Croom SRD civil birth reg | Probably died young — different Anne (b. ~1881) in 1901 household |
| ~1881 | Anne | 1901/1911 census | Likely replacement-child for 1879 Anne |
| 1884 | Patrick | Croom SRD civil birth reg | Not in 1901/1911 — fate unknown |

Pattern: at least 9 documented children; substantial child mortality typical of the era; the 1901 household represents the survivors. The 1879 Anne / ~1881 Anne replacement-child pattern is the kind of naming-reuse that also appears in our Patrick's family (Bridget #3 1868 vs Bridget #8 1881).
...
- **1940 Staten Island census** — search for Irish-born female Hayes/Hays sister-aged to James (born ~1850–1880, in Richmond County NY) to identify "Mrs. John Hayes" from James's obit. Drop the "Ella Isabel" filter since that identification was withdrawn.

---

## ~~Key chain-migration insight~~ (withdrawn 2026-06-01)

Previously this section argued Ella's 1874 Eau Claire marriage was why James later settled in Buffalo County WI (adjacent to Eau Claire). That chain-migration story is **withdrawn** — the 1874 marriage was a different Gleason family. Why James specifically settled in Buffalo County, WI rather than NYC or Boston is now an open question. Possibly via another now-unknown family connection, or simply where land/work was available in 1883.
...
- **Emigration:** obit states James **came to the US as a young man** — consistent with his ~1883 emigration (he was b. Dec 1863, so ~age 19–20)
- ✅ **RESOLVED 2026-08-20 — there were THREE printings, and all three are now transcribed.** *St. Cloud Times* 28 Jan 1946 p.5 · *Leader-Telegram* (Eau Claire) **30 Jan 1946 p.2** · *Leader-Telegram* **2 Feb 1946 p.9**. See `research/results/james-gleeson-obituaries-1946-all-printings.md`.
  - ⭐⭐ **The 2 Feb printing names the county:** *"born Dec. 21, 1864 at **Croom, County Limerick, Ireland**"* — and the **day and month match the baptism register exactly** (born 21 Dec, baptised 23 Dec 1863). Only the year is off by one. A US paper giving the right parish, the right county and the right calendar day is a far stronger anchor than "from Croom".
  - ⚠️ **Correction:** this file and the session notes had characterised the obituary as mentioning only "from Croom". That undersold it.
  - ⭐ **New fact:** he *"was employed for a time at what was then known as **Porters Mills** and Eau Claire"* — a real sawmill town on the Chippewa River below Eau Claire, independently corroborated by the 30 Jan notice and by the 1900 census occupation *"Head Sawier"*. First American workplace on record; a searchable place and period for dating the emigration.
  - ⚠️ **Burial conflict:** the local paper says *"Interment was in **Riverside** cemetery"*, not Sacred Heart. Prefer the local, post-funeral account.
  - ⚠️ **Twelve children**, five living — two or three more than we have documented.
...
- **3 surviving sisters of James:**
  ...
  - **Mrs. John Hayes** — Staten Island, NY (identity unknown — see "Mrs. John Hayes of Staten Island" open question section above)
...
**Implication for Patrick's family:** Two of Patrick's daughters (Bridget, Mary) confirmed staying in Croom for life. Only James is confirmed as an emigrant. The unidentified "Mrs. John Hayes" in NY suggests at least one other emigrant, but we don't yet know which daughter.
...
- ~~Ancestry.com, Wisconsin, U.S., Marriage Records, 1820–2015 (Box 674142) — Ella Isabel Gleason + John Nelson Hayes, 24 Dec 1874~~ (withdrawn 2026-06-01 — different Gleason family; full record names bride's father as C. R. Gleason; retained as reference for the False leads section)
- ~~Wisconsin Marriage Index (Vol. 01, p. 0229) — Ella Isabella Gleason + John Nelson Hayes, 24 Dec 1874, Eau Claire~~ (withdrawn — same record as above)
