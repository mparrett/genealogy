...
6. **Consanguinity follow-up** — Patrick × Margaret were 3rd-and-4th-degree blood kin; the shared Gleeson–Moloney ancestor (~late 1700s) is a check to apply once both trees are built, not yet a search target.
