...
- **Wife:** Margaret **Moloney** [T1] (Latin *Margaritæ Moloney* in Croom register).
  ...
  - **Margaret's natal family — Tier 1 baptism + Tier 2 identity linkage:**
    ...
    - **Identifying this Margaret as ours [now ~T1 / strong]:** the baptism proves *a* Margaret to James Molony + Catherine Kenny; identifying her as *our* Margaret rested on four convergent inferences (mother Catherine matched the pre-registered 1st-daughter prediction; Kilfinny parish; father James; 9–10 yr age-shave). **2026-06-09 — substantially strengthened:** the now-found **18 Nov 1860 marriage records the bride as "de Kilfenny" (= Croagh parish)**, and the 31 Dec 1836 Margaret is the *unique* Margaret Molony baptized in Croagh in the window (re-confirmed via FamilySearch's parent-index). Marriage-parish + baptism-uniqueness lift this from probabilistic T2 to a strong identification. NB: no record will ever directly *name* her father (the 1860 register predates the father-naming civil format) — but the convergence is now robust.
