...
3. **Second 1946 obituary paper** — we hold only *St. Cloud Times*; family recall says it ran in two. Locate + archive the second (likely Eau Claire/Alma/Mondovi-area WI). A second independent Croom obit = extra anchor on the US-side chain.
...
- ⚠️ **Only ONE of two papers is on file.** Per family knowledge the obituary ran in **two newspapers**; we currently hold only *St. Cloud Times* (28 Jan 1946, p.5). **TODO: locate + archive the second paper** (likely an Eau Claire / Alma / Mondovi-area WI paper given his children's residences) — a second independent obit naming Croom is an additional anchor on the US-side identifying chain ([[gleeson_two_chain_proof_architecture]])
