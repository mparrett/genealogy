...
- **"Jacobo Gleeson" as sponsor at 6 Sep 1864 Croom wedding** of Gulielmus Riordan + Maria Hanly — *"Jacobo Gleeson et Catherina Bardan Sponsoribus. Joannes Quinlan C.C."* (transcript at `assets/external/catherine-marriage-maybe-page-before-6.md`). Our infant James was 9 months old in Sep 1864 — too young to sponsor. This is a **different James Gleeson active in Croom 1864**. **Strong candidate for Patrick's father** per our Irish naming-pattern analysis (predicted Patrick's father = James Gleeson b. ~1797–1807). First direct attestation of a James Gleeson sibling/parent generation in Croom.
