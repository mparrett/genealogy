...
| 8 | **Bridget Gleeson** ⭐ (the second Bridget) | **born 11 Oct 1881 at Croom; civilly registered 3 Nov 1881** (group reg ID 10767889; Croom SR district, register page 189, entry 78). Father Patrick Gleeson **Shopkeeper**, mother Margaret Gleeson formerly Moloney. Informant: Patrick himself ("Patt Gleeson, Father", own signature). NLI Croom baptism register ends Jun 1881 so no parish baptism record on the swept microfilm. | → matches "Bridget Gleeson, age 18" at Main Street Croom in 1901 Census (b. ~1882–83 implied vs. actual 1881 → 1 yr understatement; common). **Repeat of name "Bridget" implies sister #3 (Bridget Feb 1868 → Mrs. Bridget O'Connor) was alive and using the name** — so the name reuse is unusual; possibly a Mrs. O'Connor sister had married by 1881 OR the second Bridget was named for a grandmother (per Irish naming, paternal grandmother → 2nd-daughter rule predicts Bridget, supporting our hypothesized "Patrick's mother = Bridget" pattern). |
...
James's 1946 obit names three surviving sisters: Bridget O'Connor (Croom), Mary Gleeson (Croom), and **Mrs. John Hayes, Staten Island, NY**. The third sister's identity is unknown:

- An earlier hypothesis identified her as "Ella Isabel Gleason" of the 1874 Eau Claire marriage — withdrawn 2026-06-01 (different family).
- Plausible candidates among documented children: Honora (1866), Ellen (1869), Margaret (1875), Jane (1878). Ages in 1946: 80, 77, 71, 68.
- Could also be an older sister we haven't found (pre-1863).
- Search strategy: 1940 Staten Island census for an Irish-born female Hayes/Hays, sister-aged to James (b. 1863), without restricting given name.
