...
- **Wife:** Margaret **Moloney** [T1] (Latin *Margaritæ Moloney* in Croom register).
  ...
  - **Margaret's natal family — Tier 1 baptism + Tier 2 identity linkage:**
    ...
    - **2026-06-08 — Margaret's natal-family chain promoted from T2 to T1.5 via Kate Moloney + Helen J. Ryan = Ellen Kelly identification.** Helen J. Ryan (1905–1989, executor on Catherine Gleeson Hayes's 1944 NY estate as "cousin") was born **Ellen Kelly on 3 March 1905 at Ballymackeamore townland, Adare district**, parents **John Kelly (Farmer) + Kate Kelly nee Moloney**. The Ballymackeamore townland is the SAME townland as Jeremiah Molony of the 1918 deed memorial (= hypothesized Margaret's brother). So **Kate Moloney is strongly inferred as Margaret's sister** (both children of James Molony + Catherine Kenny of Croagh, both at Ballymackeamore in the natal-family compound, Margaret marrying out to Croom while Kate stayed). This makes **Catherine Gleeson Hayes + Helen (Ellen Kelly) Ryan = maternal first cousins** — direct explanation of the "cousin executor" attribution in 1944 NY. See [[gleeson_helen_ryan_ellen_kelly_identified]] memory. T1 upgrade targets: (a) Croagh CPR ~1845–1860 for Kate Moloney baptism (would directly verify parents = James + Catherine); (b) Adare or Croagh CPR marriages 1880–1905 for John Kelly + Kate Moloney; (c) Patrick + Margaret marriage record (the still-outstanding direct lock).
    - **Documented Moloney sibling cluster (2026-06-08) — all strongly inferred siblings, children of James Molony + Catherine Kenny of Croagh:**
       - Margaret Moloney (b. 1836 Croagh, T1 baptism) — m. Patrick Gleeson, moved to Croom
       - James Moloney (the 1881 Croom Shopkeeper) — m. Honoria Quaid, stayed in Croom (memory [[gleeson_james_moloney_margaret_brother]])
       - Kate Moloney — m. John Kelly (Farmer), at Ballymackeamore
       - Jeremiah Molony — at Ballymackeamore (1918 deed mortgagee releasing to widow Margaret)
...
1. **Margaret's natal family — still HYPOTHESIS, now the top mystery.** No record names her father (the 1860 marriage predates civil reg). The path to a lock is **Jeremiah Moloney's parentage** (if his parents = James Molony + Catherine Kenny, and he's Margaret's brother, the family locks by convergence). Status:
   - **Croagh baptism register swept 1844–45 → NEGATIVE** for a James Molony × Catherine Kenny baptism (browser-claude, 2026-06-09). Moloneys appear only as godparents; a Michael Molony + Honora Minihan household exists, but not our target couple.
   - **RootsIreland (Limerick Genealogy, the authoritative parent-indexed source):** **2 Jeremiah Molony baptisms in Co. Limerick ~1844** (6 Ireland-wide), but **parents + parish are subscription-gated** on Matt's currently-unsubscribed account. ⛔ **BLOCKED on a short RootsIreland subscription / pay-per-credit** — that's the clean unblock to see the 2 candidates' parents and pull the whole James-Molony + Catherine-Kenny sibling set at once. (Ancestry won't help — Irish Catholic registers there are image-browse only, not parent-indexed.)
